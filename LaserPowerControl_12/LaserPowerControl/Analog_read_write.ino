...
float analog_write_2V(float serial_read_value)//analog write input is the percetage of 2V, i.e. 10% is 200mv
{
...
float analog_read(const int analogInPin)//read voltage
